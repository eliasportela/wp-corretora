	...
	public function Register() {
		...
		if ($dataRegister['nome_propriedade'] != NULL):
			...
			$dataModel = array(
				...
				'id_tipo_terreiro' => trim($dataRegister['id_tipo_terreiro']),
				'id_tipo_processamento' => trim($dataRegister['id_tipo_processamento']),
				'id_processamento_via_umido' => trim($dataRegister['id_processamento_via_umido']),
