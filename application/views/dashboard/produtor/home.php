...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container w3-cell-row" style="padding-top:22px">
    ...
    <a class="w3-button w3-black w3-right" style="margin-right: 12px" href="<?=base_url('admin/produtor')?>">Limpar Filtros</a>
  </header>
  <div class="w3-panel">
        ...
        <form method="GET" action="<?=base_url("admin/contatos")?>">
          <div class="w3-row-padding w3-center">
            ...
            <div class="w3-col l3">
              ...
              <input type="text" class="w3-input w3-border" placeholder="Informe o Tipo" name="">
            </div>
            <div class="w3-col l3">
